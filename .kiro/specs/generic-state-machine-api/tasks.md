...
- [ ] 1. Foundation: New attributes, data models, and FsCheck generators
  - [ ] 1.1 Create new attribute classes (`InitialStateAttribute`, `TerminalStateAttribute`, `OnEnterAttribute`, `OnTerminalAttribute`)
  ...
  - [ ] 1.2 Update existing attributes (`TransitionAttribute`, `GuardAttribute`, `SideEffectAttribute`) to accept `int` parameters
  ...
  - [ ] 1.3 Create new data model types (`ParsedEvent`, `ParsedEntryCallback`, `ParsedCleanupHandler`, `ValidatedEntryCallback`)
  ...
  - [ ] 1.4 Update existing data models (`ParsedStateMachine`, `ValidatedStateMachine`, `ValidatedTransition`, `ValidatedState`, `HandlerKind`)
  ...
  - [ ] 1.5 Create `TransitionResult<TState>` and `TransitionOutcome` types in the Attributes project
  ...
  - [ ] 1.6 Create FsCheck custom `Arbitrary` generators for new data models
...
- [ ] 3. New diagnostics descriptors (SMSG018–SMSG027)
  - [ ] 3.1 Add diagnostic descriptors to `DiagnosticDescriptors.cs`
...
- [ ] 4. Parsing stage: Tests first, then implementation
  - [ ] 4.1 Write property test: Enum member extraction produces complete state set (Property 1)
  ...
  - [ ] 4.2 Write property test: Enum member extraction produces complete event set (Property 2)
  ...
  - [ ] 4.3 Write property test: Integer-to-enum resolution round trip (Property 4)
  ...
  - [ ] 4.4 Implement updated `DeclarationParser` for 4-type-parameter resolution
  ...
  - [ ] 4.5 Implement updated `HandlerParser` for int-to-enum resolution
  ...
  - [ ] 4.6 Update `SyntaxExtractor` to recognize new attribute patterns
  ...
  - [ ] 4.7 Update `ParsedModelFactory` to assemble new model shape
...
- [ ] 6. Analysis stage: Tests first, then implementation
  - [ ] 6.1 Write property test: `[Flags]` enum produces diagnostic (Property 3)
  ...
  - [ ] 6.2 Write property test: Invalid enum value produces diagnostic (Property 5)
  ...
  - [ ] 6.3 Write property test: Initial state cardinality enforcement (Property 6)
    - **Property 6: Initial state cardinality enforcement**
    - Zero [InitialState] → SMSG005; multiple [InitialState] → SMSG006
    - **Validates: Requirements 3.2, 3.3**

  - [ ] 6.4 Write property test: Valid definitions produce no SMSG002/SMSG003 (Property 7)
  ...
  - [ ] 6.5 Write property test: Duplicate transition detection preserved (Property 8)
    - **Property 8: Duplicate transition detection preserved**
    - Two+ handlers with same (From, To, Trigger) triple → SMSG001
    - **Validates: Requirements 6.4**

  - [ ] 6.6 Write property test: Unreachable state detection for enum members (Property 9)
  ...
  - [ ] 6.7 Write property test: Entry callback uniqueness enforcement (Property 13)
  ...
  - [ ] 6.8 Write property test: Cleanup handler uniqueness enforcement (Property 14)
    - **Property 14: Cleanup handler uniqueness enforcement**
    - Multiple [OnTerminal] methods → SMSG021
    - **Validates: Requirements 10.8**

  - [ ] 6.9 Implement `EnumValidator` (new validator)
  ...
  - [ ] 6.10 Update `StateValidator` for `[InitialState]`/`[TerminalState]` validation
  ...
  - [ ] 6.11 Implement `EntryCallbackValidator` (new validator)
  ...
  - [ ] 6.12 Update `TransitionValidator` for enum-based validation
  ...
  - [ ] 6.13 Update `SignatureValidator` for entry callback and cleanup handler signatures
  ...
  - [ ] 6.14 Update `AnalysisPipeline` to wire new validators and build updated `ValidatedStateMachine`
...
- [ ] 8. Generation stage: Tests first, then implementation
  - [ ] 8.1 Write property test: Generated dispatch uses enum comparisons (Property 10)
  ...
  - [ ] 8.2 Write property test: Non-terminal orchestration ordering (Property 11)
  ...
  - [ ] 8.3 Write property test: Terminal orchestration ordering (Property 12)
  ...
  - [ ] 8.4 Write property test: Targeted entry callback returns TState (Property 15)
  ...
  - [ ] 8.5 Write property test: Catch-all entry callback is void and observational (Property 16)
  ...
  - [ ] 8.6 Write property test: Terminal transition without cleanup completes normally (Property 17)
  ...
  - [ ] 8.7 Write property test: Generated code compiles without errors (Property 18)
  ...
  - [ ] 8.8 Rewrite `EventDispatchEmitter` for enum-based switch dispatch
  ...
  - [ ] 8.9 Update `OrchestrationEmitter` for new ordering with entry callbacks
  ...
  - [ ] 8.10 Implement `EntryCallbackEmitter` (new emitter)
  ...
  - [ ] 8.11 Implement `CleanupEmitter` (new emitter)
  ...
  - [ ] 8.12 Update `HandleMethodEmitter` for enum types and `TransitionResult<TState>` return type
  ...
  - [ ] 8.13 Update `GenerationPipeline` to wire new emitters
...
- [ ] 10. Pipeline wiring and integration
  - [ ] 10.1 Update `StateMachineGenerator` incremental pipeline for new parsing flow
  ...
  - [ ] 10.2 Write integration tests: Full pipeline compilation (Property 18 end-to-end)
...
- [ ] 12. Playground migration and documentation
  - [ ] 12.1 Migrate `OrderMachine` playground to new generic enum-based API
  ...
  - [ ] 12.2 Add guard example to playground
  ...
  - [ ] 12.3 Add side-effect example to playground
  ...
  - [ ] 12.4 Update README with guards and side-effects documentation
  ...
  - [ ] 12.5 Update README with new generic API documentation
