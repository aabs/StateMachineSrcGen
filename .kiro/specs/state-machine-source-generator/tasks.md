...
- [x] 1. Project scaffolding and infrastructure
  - [x] 1.1 Create solution structure and project files
  ...
  - [x] 1.2 Create marker attributes in the Attributes assembly
  ...
  - [x] 1.3 Create user-facing interfaces in the Attributes assembly
  ...
  - [x] 1.4 Create diagnostic descriptors
...
- [x] 2. Data models and value equality
  - [x] 2.1 Write property tests for data model equality
  ...
  - [x] 2.2 Write property tests for EquatableArray
  ...
  - [x] 2.3 Implement EquatableArray<T>
  ...
  - [x] 2.4 Implement pipeline data models
...
- [x] 4. Parsing stage — tests first
  - [x] 4.1 Write property tests for handler attribute parsing
  ...
  - [x] 4.2 Write property tests for class declaration validation
  ...
  - [x] 4.3 Write property tests for IStateMachine implementation validation
  ...
  - [x] 4.4 Write property tests for handler signature validation
    - Add tests in `src/StateMachineSrcGen.Tests/Parsing/HandlerParsingProperties.cs`
  ...
  - [x] 4.5 Write property tests for IStatePersistence validation
    - Add tests in `src/StateMachineSrcGen.Tests/Parsing/HandlerParsingProperties.cs`
  ...
  - [x] 4.6 Write property tests for IDispatchableEvent validation
  ...
  - [x] 4.7 Write property tests for parsing reliability
  ...
  - [x] 4.8 Write property tests for parsing determinism
  ...
  - [x] 4.9 Implement SyntaxExtractor
  ...
  - [x] 4.10 Implement DeclarationParser
  ...
  - [x] 4.11 Implement HandlerParser
  ...
  - [x] 4.12 Implement ParsedModelFactory
...
- [x] 5. Checkpoint — Parsing stage complete
  - Ensure all tests pass (`dotnet test`), ask the user if questions arise.

- [x] 6. Analysis stage — tests first
  - [x] 6.1 Write property tests for duplicate detection
  ...
  - [x] 6.2 Write property tests for reference validation
  ...
  - [x] 6.3 Write property tests for reachability analysis
  ...
  - [x] 6.4 Write property tests for error emission behavior
  ...
  - [x] 6.5 Write property tests for analysis reliability
  ...
  - [x] 6.6 Write property tests for analysis determinism
  ...
  - [x] 6.7 Implement StructureValidator
  ...
  - [x] 6.8 Implement StateValidator
  ...
  - [x] 6.11 Implement SignatureValidator
  ...
  - [x] 6.12 Implement AnalysisPipeline (orchestrates validators)
...
- [x] 7. Checkpoint — Analysis stage complete
  - Ensure all tests pass (`dotnet test`), ask the user if questions arise.

- [x] 8. Generation stage — tests first
  - [x] 8.1 Write property tests for compilation correctness
  ...
  - [x] 8.2 Write property tests for code quality
  ...
  - [x] 8.3 Write property tests for generation reliability
  ...
  - [x] 8.4 Write property tests for generation determinism
  ...
  - [x] 8.5 Implement HandleMethodEmitter
  ...
  - [x] 8.6 Implement EventDispatchEmitter
  ...
  - [x] 8.7 Implement TransitionEvaluator emitter
  ...
  - [x] 8.11 Implement SourceFormatter
  ...
  - [x] 8.12 Implement GenerationPipeline (orchestrates emitters)
...
- [x] 9. Checkpoint — Generation stage complete
  - Ensure all tests pass (`dotnet test`), ask the user if questions arise.

- [x] 10. Orchestration behavior — tests first
  - [x] 10.1 Write property tests for transition dispatch correctness
  ...
  - [x] 10.2 Write property tests for guard-gated transition selection
  ...
  - [x] 10.3 Write property tests for failure handling
  ...
  - [x] 10.4 Write property tests for lock lifecycle
...
- [x] 11. Pipeline wiring and incremental generator
  - [x] 11.1 Implement the IIncrementalGenerator pipeline orchestrator
  ...
  - [x] 11.2 Implement incremental caching integration
...
- [x] 12. Checkpoint — Pipeline wiring complete
  - Ensure all tests pass (`dotnet test`), ask the user if questions arise.

- [x] 13. Integration tests
  - [x] 13.1 Write end-to-end compilation integration tests
  ...
  - [x] 13.2 Write incremental cache integration tests
  ...
  - [x] 13.3 Write NuGet packaging validation tests
  ...
  - [x] 13.4 Write snapshot/approval tests for generated output stability
...
- [x] 14. FsCheck custom generators
  - [x] 14.1 Implement FsCheck Arbitrary generators for pipeline data models
...
- [x] 15. NuGet packaging and CI/CD
  - [x] 15.1 Configure NuGet package metadata and packaging
  ...
  - [x] 15.2 Create GitHub Actions release workflow
